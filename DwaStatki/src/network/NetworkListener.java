...
public class NetworkListener extends Listener {
    ...
    public void received(Connection connection, Object obj) {
        if (obj instanceof Packet.Data) {
            ...
            clientData.setPoints(revicePacket.getPoints());
        ...
        if (obj instanceof Packet.PauseState) {
            ...
            System.out.println(String.valueOf(receivedPacket.isPauseState()));
            clientData.setGamePaused(receivedPacket.isPauseState());
        }
    }
}
